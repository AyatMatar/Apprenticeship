...
namespace FinalProject.Controllers
{
    ...
    public class AdmanSupervisorController : Controller
    {
        ...
        public IActionResult Dashboard()
        {
            ...
            dashboard.NumApprenticeships = ApprenticeshipList.Count;
            dashboard.NumStudentes = ApprenticeshipList.Count;
            dashboard.NumAssiments = 0;
            dashboard.NumObjectives = 0;
            
            foreach (var traning in ApprenticeshipList)
            {
                
                dashboard.NumAssiments += traning.assignments.Count;
                dashboard.NumObjectives += traning.apprenticeshipsObjectives.Count;
